...
<html lang="en">
	<head>
		...
		<meta name="author" content="Kapish Vibute">
		<title> Shopify | <?php echo $pageTitle ?> </title>
	...
	<body>
		...
		<div class="page-wrapper">
			<header class="header" id="header">
				<div style ="background-color:DARKORANGE; font-weight:bold;"class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							<div style ="color:black;" class="header-dropdown">
								<a href="#">WELCOME TO SHOPIFY</a>
						...
						<div style ="color:black;" class="header-right">
				...
				<div style="background-image: url('https://static.vecteezy.com/system/resources/previews/000/694/606/original/abstract-colorful-geometric-banner-template-background-vector.jpg');" class="header-middle">
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 120px;" src="public/assets/images/favicon/logoFront.png" alt="SuperShop Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+919322870811</strong></a>
							</div>
