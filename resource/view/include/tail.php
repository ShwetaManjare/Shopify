							...
							<div class="col-lg-2 col-md-6">
								<div class="widget">
									...
									<ul class="links">
										...
										<li><a href="register-account.php">My Account</a></li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										...
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">admin@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//aamroni.info" target="_blank">SHOPIFY </a>
						</p>
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						<div class="modal-header">
							<img src="public/assets/images/favicon/logoFront.png" alt="Logo" class="logo-newsletter">
						</div>
