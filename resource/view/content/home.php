...
<!--=*= HOME SECTION START =*=-->
<main class="main">
	<div style ="background-color:lavender;" class="home-top-container">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
	...
	<div style ="background-color:darkblue;" class="info-boxes-container" >
		<div class="container">
			<div class="info-box">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="home-product-tabs">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="featured-products-tab" data-toggle="tab" href="#featured-products" role="tab" aria-controls="featured-products" aria-selected="true"></a>
						</li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane fade show active" id="featured-products" role="tabpanel" aria-labelledby="featured-products-tab">
