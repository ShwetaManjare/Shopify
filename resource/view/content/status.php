						...
						<div class="row">
							<div class="col-md-3 col-xs-2">
								<div class="invoice-title">
									<h1>invoice</h1>
									<img class="logo-print" src="public/assets/images/favicon/logoFront.png" alt="" style="width: 80px; height: 90px;">
								</div>
							</div>
						...
						<div class="invoice-header">
							<div class="row">
								<div class="col-md-3 col-xs-2">
									<div class="invoice-title">
										<h1>invoice</h1>
										<img class="logo-print" src="public/assets/images/favicon/logoFront.png" alt="" style="width: 180px; height: 100px; margin-left:20px; margin-top:5px;" >
									</div>
								</div>
								<div class="invoice-info  col-md-9 col-xs-10">
									<div style="padding-left: 340px;">
