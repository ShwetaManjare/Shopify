					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:admin@hotmail.com"> 
									<i class="fa fa-envelope"></i> &nbsp; admin@hotmail.com 
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:8801316440504" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +919322870811
								</a>
								<a class="btn p-follow-btn" href="skype:live:.cid.5ed7daebee5e7820"> 
									<i class="fa fa-skype"></i> &nbsp; admin
								</a>
							</div>
						</div>
					</div>
						...
						<div class="carousel slide auto panel-body" id="c-slide">
							...
							<div class="carousel-inner">
								<div class="item text-center active">
									<h3> SHOPIFY| ONLINE SHOPPING STORE </h3>
									<p> frontEnd Development </p>
									<p class="text-muted">
										Shopify.com is a eCommerce application where all of the data is totally dynamic content
									</p>
								</div>
