...
<html lang="en">
	<head>
		...
		<meta name="author" content="Kapish Vibhute">
		
		<title>Admin Login | Shopify</title>
		...
		<div class="container">
			<form class="form-signin" method="post" action="">
				<div class="form-signin-heading text-center">
					...
					<img class="disable" src="../public/assets/images/favicon/logoFront.png" alt="" style="height: 126px;"/>
				</div>
